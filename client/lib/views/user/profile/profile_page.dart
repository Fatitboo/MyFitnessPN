                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              controller.hctrl.loginResponse.fullName ?? "User systerm",
                              style: TextStyle(
                            ...
                            Text(
                              "${controller.userHealthDTO.value.goal} program",
                              style: TextStyle(
                                color: AppColor.gray,
                                fontSize: 14,
                              ),
                      ...
                      SizedBox(
                        ...
                        child: RoundButton(
                          ...
                          onPressed: () {
                            Get.toNamed(AppRoutes.WELCOME, parameters: {"type":"EditProfile"});
                          },
                        ),
                      )
                    ],
                    ...
                    children: [
                      Expanded(
                        child: TitleSubtitleCell(
                          title: "${controller.userHealthDTO.value.height ?? 180}",
                          subtitle: "Height",
                        ),
                      ),
                      const SizedBox(
                      ...
                      Expanded(
                        child: TitleSubtitleCell(
                          title: "${controller.userHealthDTO.value.weight}",
                          subtitle: "Weight",
                        ),
                      ),
                      const SizedBox(
                      ...
                      Expanded(
                        child: TitleSubtitleCell(
                          title: "${controller.userHealthDTO.value.age ?? 18}",
                          subtitle: "Age",
                        ),
                      ),
                    ],
                        ...
                        InkWell(
                          ...
                          child: SizedBox(
                            ...
                            child: Row(
                              ...
                              children: [
                                const Icon(Icons.add_chart_sharp, color: Colors.blueAccent),
                                const SizedBox(
                                  width: 15,
                                ),
                                Expanded(
                        ...
                        InkWell(
                          ...
                          child: SizedBox(
                            ...
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                const Icon(Icons.pause_presentation_outlined, color: Colors.blueAccent),
                                const SizedBox(
                                  width: 15,
                                ),
                                Expanded(
                        ...
                        InkWell(
                          ...
                          child: SizedBox(
                            ...
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                const Icon(Icons.chat_outlined, color: Colors.blueAccent),
                                const SizedBox(
                                  width: 15,
                                ),
                                Expanded(
                        ...
                        InkWell(
                          ...
                          child: SizedBox(
                            ...
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                const Icon(Icons.mail_lock_outlined, color: Colors.blueAccent),
                                const SizedBox(
                                  width: 15,
                                ),
                                Expanded(
