...
class UserHealthDTO {
  ...
  factory UserHealthDTO.fromJson(Map<String, dynamic> json) => UserHealthDTO(
    userHealthId: json["userHealthId"],
    userId: json["userId"],
    height: json["height"],
    weight: json["weight"],
    age: json["age"],
    ...
    bodyFatPercentage: BodyFatPercentage.fromJson(json["bodyFatPercentage"]),
    leanBodyMass: BodyFatPercentage.fromJson(json["leanBodyMass"]),
    restingDailyEnergyExpenditure: RestingDailyEnergyExpenditure.fromJson(json["restingDailyEnergyExpenditure"]),
    basalMetabolicRate: BasalMetabolicRate.fromJson(json["basalMetabolicRate"]),
    totalDailyEnergyExpenditure: BasalMetabolicRate.fromJson(json["totalDailyEnergyExpenditure"]),
    idealBodyWeight: IdealBodyWeight.fromJson(json["idealBodyWeight"]),
  );

  double getCaloriesNeed(){
    return totalDailyEnergyExpenditure.bmi?.calories.value ?? 2000;
  }
  double getBmi(){
    return bodyMassIndex.value;
  }
  String getBmiStatus(){
    return bodyMassIndex.conclusion;
  }
